! function(e, t) {
    ...
    function x(e) {
        var t = J,
            n = $t[e];
        return n || (n = y(e, t), "none" !== n && n || (Wt = (Wt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Wt[0].contentDocument, t.write(), t.close(), n = y(e, t), Wt.detach()), $t[e] = n), n
    }
    ...
    function k(e, t, n) {
        ...
        if (0 >= i || null == i) {
            if (i = b(e, t, o), (0 > i || null == i) && (i = e.style[t]), It.test(i)) return i;
    ...
    function L(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], l = Z.css(e, "display"), c = "none" === l ? vt.get(e, "olddisplay") || x(e.nodeName) : l, "inline" === c && "none" === Z.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function() {
        ...
        if (Z.isEmptyObject(p)) "inline" === ("none" === l ? x(e.nodeName) : l) && (d.display = l);
            ...
            for (r in p) s = A(h ? g[r] : 0, r, f), r in g || (g[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    var it = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : B) !== q && L(t), t = t || q, n = n || [], !e || "string" != typeof e) return n;
            ...
            if (O && !r) {
                if (i = yt.exec(e))
                    if (s = i[1]) {
                        ...
                        if ((s = i[3]) && w.getElementsByClassName && t.getElementsByClassName) return et.apply(n, t.getElementsByClassName(s)), n
                    }
                if (w.qsa && (!F || !F.test(e))) {
            ...
            return i && !i[W] && (i = v(i)), o && !o[W] && (o = v(o, s)), r(function(r, s, a, u) {
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = x.length; c--;)(f = x[c]) && (l = o ? nt.call(r, f) : p[c]) > -1 && (r[l] = !(s[l] = f))
                    }
                } else x = m(x === s ? x.splice(h, x.length) : x), o ? o(null, s, x, u) : et.apply(s, x)
            })
        }
                ...
                if (n = T.relative[e[a].type]) c = [d(h(c), n)];
                    ...
                    if (n = T.filter[e[a].type].apply(null, e[a].matches), n[W]) {
                        ...
                        return v(a > 1 && h(c), a > 1 && p(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(lt, "$1"), n, r > a && y(e.slice(a, r)), i > r && y(e = e.slice(r)), i > r && p(e))
                    }
                    c.push(n)
                }
            return h(c)
            ...
            var i = n.length > 0,
                ...
                s = function(r, s, a, u, l) {
                    ...
                    if (d += h, i && h !== d) {
                        ...
                        et.apply(u, v), l && !r && v.length > 0 && d + n.length > 1 && t.uniqueSort(u)
                    }
                    return l && (I = b, j = y), g
                };
            return i ? r(s) : s
        ...
        w = t.support = {}, N = t.isXML = function(e) {
            ...
            return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, H = n.documentElement, O = !N(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
            ...
            }, P = [], F = [], (w.qsa = $.test(n.querySelectorAll)) && (i(function(e) {
                e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && F.push("[*^$]=" + it + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || F.push("\\[" + it + "*(?:value|" + rt + ")"), e.querySelectorAll(":checked").length || F.push(":checked")
            }), i(function(e) {
                var t = n.createElement("input");
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && F.push("name" + it + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || F.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), F.push(",.*:")
            })), (w.matchesSelector = $.test(M = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function(e) {
                w.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), P.push("!=", ut)
            }), F = F.length && new RegExp(F.join("|")), P = P.length && new RegExp(P.join("|")), t = $.test(H.compareDocumentPosition), R = t || $.test(H.contains) ? function(e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === B && R(B, e) ? -1 : t === n || t.ownerDocument === B && R(B, t) ? 1 : D ? nt.call(D, e) - nt.call(D, t) : 0 : 4 & r ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== q && L(e), n = n.replace(pt, "='$1']"), !(!w.matchesSelector || !O || P && P.test(n) || F && F.test(n))) try {
                var r = M.call(e, n);
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return gt.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && dt.test(n) && (t = k(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                ...
                PSEUDO: function(e, n) {
                    ...
                    return o[W] ? o(n) : o.length > 1 ? (i = [e, e, "", n], T.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
                        for (var r, i = o(e, n), s = i.length; s--;) r = nt.call(e, i[s]), e[r] = !(t[r] = i[s])
                    }) : function(e) {
                        return o(e, 0, i)
                    }) : o
                }
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, k = t.tokenize = function(e, n) {
            ...
            for (a = e, u = [], l = T.preFilter; a;) {
                (!r || (i = ct.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push(o = [])), r = !1, (i = ft.exec(a)) && (r = i.shift(), o.push({
                    value: r,
                    type: i[0].replace(lt, " ")
                }), a = a.slice(r.length));
                for (s in T.filter) !(i = gt[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (i = gt.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !T.relative[a = s.type]);)
        ...
        }, w.sortStable = W.split("").sort(V).join("") === W, w.detectDuplicates = !!A, L(), w.sortDetached = i(function(e) {
    ...
    Z.Callbacks = function(e) {
        ...
        when: function(e) {
            var t = 0,
                n = _.call(arguments),
                r = n.length,
                i = 1 !== r || e && Z.isFunction(e.promise) ? r : 0,
                o = 1 === i ? e : Z.Deferred(),
                s = function(e, t, n) {
                    return function(r) {
                        t[e] = this, n[e] = arguments.length > 1 ? _.call(arguments) : r, n === a ? o.notifyWith(t, n) : --i || o.resolveWith(t, n)
                    }
                },
                a, u, l;
            if (r > 1)
                for (a = new Array(r), u = new Array(r), l = new Array(r); r > t; t++) n[t] && Z.isFunction(n[t].promise) ? n[t].promise().done(s(t, l, n)).fail(o.reject).progress(s(t, u, a)) : --i;
    ...
    Z.event = {
        ...
        return this instanceof Z.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? l : $) : this.type = e, t && Z.extend(this, t), this.timeStamp = e && e.timeStamp || Z.now(), void(this[Z.expando] = !0)) : new Z.Event(e, t)
    }, Z.Event.prototype = {
        isDefaultPrevented: $,
    ...
    Rt.optgroup = Rt.option, Rt.tbody = Rt.tfoot = Rt.colgroup = Rt.caption = Rt.thead, Rt.th = Rt.td, Z.extend({
        ...
        buildFragment: function(e, t, n, r) {
            ...
            for (c.textContent = "", p = 0; i = f[p++];)
                if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = m(c.appendChild(i), "script"), u && h(o), n))
        ...
        remove: function(e, t) {
            for (var n, r = e ? Z.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || Z.cleanData(m(n)), n.parentNode && (t && Z.contains(n.ownerDocument, n) && h(m(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        domManip: function(e, t) {
            ...
            var n, r, i, o, s, a, u = 0,
                ...
                h = e[0],
                g = Z.isFunction(h);
            if (g || l > 1 && "string" == typeof h && !Q.checkClone && Ot.test(h)) return this.each(function(n) {
                var r = c.eq(n);
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)
                    for (a = i[i.length - 1].ownerDocument, Z.map(i, d), u = 0; o > u; u++) s = i[u], Ft.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Mt, "")))
            }
            return this
        }
    }), Z.each({
    ...
    Z.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, s, a = Z.camelCase(t);
            return t = Z.cssProps[a] || (Z.cssProps[a] = T(e.style, a)), s = Z.cssHooks[t] || Z.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = b(e, t, r)), "normal" === i && t in Yt && (i = Yt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
        ...
        Z.cssHooks[t] = {
            ...
            set: function(e, n, r) {
                var i = r && _t(e);
                return C(e, n, r ? N(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    ...
    pn = bn.exec(dn.toLowerCase()) || [], Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || dn) + "").replace(hn, "").replace(xn, pn[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(dt) || [""], null == f.crossDomain && (u = bn.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === pn[1] && u[2] === pn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (pn[3] || ("http:" === pn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), F(wn, f, t, w), 2 === x) return w;
    ...
    Z.offset = {
        ...
        offset: function(e) {
            ...
            var t, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== kt && (i = r.getBoundingClientRect()), n = B(o), {
        ...
        Z.cssHooks[t] = w(Q.pixelPosition, function(e, n) {
            return n ? (n = b(e, t), It.test(n) ? Z(e).position()[t] + "px" : n) : void 0
        })
    }), Z.each({
        Height: "height",
        Width: "width"
